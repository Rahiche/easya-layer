...
exports.TrustSetHandler = exports.CurrencyCodeValidator = void 0;
...
class CurrencyCodeValidator {
    ...
    static convertFromHex(hex) {
        return (0, xrpl_1.convertHexToString)(hex);
    }
    static validateStandardCode(code) {
        ...
        const isValid = [...code].every(char => (char >= 'A' && char <= 'Z') ||
            (char >= 'a' && char <= 'z') ||
            (char >= '0' && char <= '9') ||
    ...
    static validateNonstandardCode(code) {
    ...
    static validateForIssuance(config) {
...
exports.CurrencyCodeValidator = CurrencyCodeValidator;
CurrencyCodeValidator.STANDARD_LENGTH = 3;
CurrencyCodeValidator.NONSTANDARD_LENGTH = 40;
CurrencyCodeValidator.ALLOWED_SPECIAL_CHARS = ['?', '!', '@', '#', '$', '%', '^', '&', '*', '<', '>', '(', ')', '{', '}', '[', ']', '|'];
class TrustSetHandler {
    static createLimitAmount(currencyCode, issuer, value) {
...
exports.TrustSetHandler = TrustSetHandler;
// Example usage:
/*
